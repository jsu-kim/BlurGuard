...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_file', type=str, default="./GrIDPure/imagenet.yml")
    parser.add_argument('--pure_model', type=str, default="./model")
    ...
    img_file_list = [f for f in img_file_list if '.ipynb_checkpoints' not in f]
    for img_idx, img_file in tqdm(enumerate(img_file_list), total=len(img_file_list)):
        ...
        file_name = Path(output_dir) / img_file
        img.save(file_name)
